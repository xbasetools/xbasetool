...
<ul>
  <li>
    To Check The SMTP ( Deliver or not ) , Click on Send ( For Free ) Then Check Your Testing E-mail.
  </li>
 <li>
  There is <b> 2128 </b> Accounts Available.
</li>  
</ul>
 </div>
...
<div class="row m-3 pt-1" style="color: var(--font-color);">
 ...
 <label for="country" style="margin-bottom: 10px; margin-top: 5px">Country :</label><select name="country" id="country" class="form-control" style="color: var(--font-color); background-color: var(--color-card);"><option value="">All Countries</option>
